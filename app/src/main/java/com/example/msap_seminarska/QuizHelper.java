...
import com.example.msap_seminarska.QuizContract.QuestionsTable;
import com.example.msap_seminarska.QuizContract.CategoriesTable;
...
//called every time we open/ edit the data base
    ...
    private void fillQuestionsTable() {
        Question q1 = new Question("Programming, Hard: What kind of design " +
                "pattern Broadcast receiver  use?" ,
                "Publish-Subscribe", "Singleton", "Adapter", 1,
                Question.DIFFICULTY_HARD, Category.PROGRAMMING);
        insertQuestion(q1);

        Question q11 = new Question("Programming, Medium: What kind of design" +
                " pattern Broadcast receiver  use?" ,
                "Publish-Subscribe", "Singleton", "Adapter", 1,
                Question.DIFFICULTY_MEDIUM, Category.PROGRAMMING);
        insertQuestion(q11);

        Question q12 = new Question("Programming, Easy: What kind of design " +
                "pattern Broadcast receiver  use?" ,
                "Publish-Subscribe", "Singleton", "Adapter", 1,
        ...
        Question q4 = new Question("Music, Easy: In what year this song" +
                " has been written?",
                "2000", "1998", "2003", 1,
                Question.DIFFICULTY_EASY, Category.MUSIC);
        insertQuestion(q4);

        Question q5 = new Question("Programming, Easy: Inorder to use malloc " +
                "you need to include:",
                "stdlib", "stdio", "string", 1,
                Question.DIFFICULTY_EASY, Category.PROGRAMMING);
        insertQuestion(q5);

        Question q51 = new Question("Programming, Medium: Inorder to use malloc" +
                " you need to include:",
                "stdlib", "stdio", "string", 1,
                Question.DIFFICULTY_MEDIUM, Category.PROGRAMMING);
        insertQuestion(q51);

        Question q52 = new Question("Programming, Hard: Inorder to use malloc" +
                " you need to include:",
                "stdlib", "stdio", "string", 1,
                Question.DIFFICULTY_HARD, Category.PROGRAMMING);
        insertQuestion(q52);
        ...
        Question q9 = new Question("Programming, Hard: Which of the following is a" +
                " legal identifier " +
        ...
        Question q10 = new Question("Programming, Easy: Which of these is a Python" +
                " control flow statement type?",
                "else if", "elif", "elsif", 2,
                Question.DIFFICULTY_EASY, Category.PROGRAMMING);
        insertQuestion(q10);

        Question q13 = new Question("Programming, Easy: In C++ Which of the following" +
                " operators has the highest precedence?",
                "!", "&&", "!=", 1,
                Question.DIFFICULTY_EASY, Category.PROGRAMMING);
        insertQuestion(q13);

        Question q14 = new Question("Programming, Easy: Which of the following data " +
                "structures falls under the category of a 'dictionary'?",
                "Hash table", "Linked list", "Hash", 1,
                Question.DIFFICULTY_EASY, Category.PROGRAMMING);
        insertQuestion(q14);

        Question q15 = new Question("Programming, Hard: In 1983, this person was the" +
                " first to offer a definition of the term 'computer virus'.",
                "McAfee", "Cohen", "Norton", 2,
                Question.DIFFICULTY_HARD, Category.PROGRAMMING);
        insertQuestion(q15);

        Question q16 = new Question("Programming, Easy: Which of these structures" +
        ...
        Question q18 = new Question("Geography, Medium:  What razor-thin country" +
                " accounts for more than half of the western coastline of South America?",
        ...
        Question q24 = new Question("Geography, Easy: What country has the " +
                "most natural lakes?",
                "India", "Canada", "USA", 2,
                Question.DIFFICULTY_EASY, Category.GEOGRAPHY);
        insertQuestion(q24);

        Question q25 = new Question("Geography, Medium: What country has the " +
                "most natural lakes?",
                "India", "Canada", "USA", 2,
                Question.DIFFICULTY_MEDIUM, Category.GEOGRAPHY);
        insertQuestion(q25);
